...
it('rejects malformed hazard route queries', async () => {
  for (const query of ['url=https://evil.example', 'municipality=abc', 'municipality=0000', 'municipality=5001&start=bad-date', 'municipality=5001&start=2026-99-99', 'municipality=5001&start=2026-06-04&end=2026-06-03', 'municipality=5001&start=2030-01-01']) {
