...
it('shows source document metadata before body', () => {
  const source = { id: 'src-5-punktsordre', title: 'SRC - 5-punktsordre', sourcePath: '/vault/source-extracts/SRC - 5-punktsordre.md', sourceType: 'source-extract', status: 'unverified', warnings: ['Kontroller mot planverk'], body: 'Situasjon og oppdrag' } as SourceDocument;
  ...
  expect(screen.getByText('/vault/source-extracts/SRC - 5-punktsordre.md')).toBeInTheDocument();
});
