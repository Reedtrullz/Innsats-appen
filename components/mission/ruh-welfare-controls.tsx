...
export function RuhWelfareControls({ mission, onMissionChange }: { mission: MissionContext; onMissionChange: (missionId: string, update: MissionUpdate) => Promise<void> }) {
  ...
  return (
    <section id="ruh-velferd" className="scroll-mt-24 space-y-4 rounded-2xl bg-white p-4 shadow-sm ring-1 ring-slate-200">
        ...
        {[
          ...
          return (
            <button
              ...
              onClick={() => setActivePanel(panel as RuhWelfarePanel)}
              className={selected
                ? 'min-h-11 rounded-xl bg-[#082F49] px-3 text-sm font-black text-white'
                : 'min-h-11 rounded-xl px-3 text-sm font-black text-slate-700 hover:bg-white'}
            >
              {label}
            </button>
          );
        ...
        <div className="space-y-3">
          ...
          <div className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-amber-950">
            ...
            <details className="mt-3 rounded-xl border border-amber-200 bg-white/70 p-3">
              <summary className="min-h-11 cursor-pointer list-none text-sm font-black">JSON eksport</summary>
              <div className="mt-3 grid gap-2 sm:grid-cols-2">
      ...
      <details className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-sm font-semibold text-slate-800">
        <summary className="min-h-11 cursor-pointer list-none font-black text-slate-950">MVP-notater</summary>
