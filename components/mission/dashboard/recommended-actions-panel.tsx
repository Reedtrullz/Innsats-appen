...
export function RecommendedActionsPanel({ recommendedLabel, criticalActions, firstActions, mission }: { recommendedLabel: string; criticalActions: ActionCard[]; firstActions: ActionCard[]; mission: MissionContext }) {
